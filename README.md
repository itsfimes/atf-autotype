...
- 1. Make sure you have [Python](https://www.python.org/downloads/) installed. (The recommended version is `3.13.7`)
- 2. Install the requirements
    - (`pip install -r requirements.txt`)
- 3. Open `autotype.py` and edit it so `monitor_id` and `typing_speed` are correct.
